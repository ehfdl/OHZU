...
const AlarmModal = ({
  ...
  return (
    <div>
      ...
      />
      <div className="sm:w-[348px] sm:h-[480px] w-full h-full fixed top-0 sm:top-14 left-0 py-3 px-3 mt-0 sm:mt-4 sm:left-52 rounded bg-white sm:border-second sm:border-[1px] z-20 flex flex-col justify-start items-center sm:absolute">
        <button
          aria-label="close"
