...
const UserDropdown = ({
  ...
  return (
    <div className="w-[111px] h-[132px] rounded bg-white border-primary border-[1px] z-30 flex flex-col justify-around absolute">
      <label onChange={() => setCateDrop("최신순")} className="w-full h-[33px]">
        ...
        />
        <span className="w-full h-full flex justify-center items-center text-[#828293] peer-checked:text-primary hover:bg-second cursor-pointer">
          최신순
        </span>
      </label>
